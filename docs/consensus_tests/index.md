...
The consensus tests in `./tests/` verify that Sila execution clients implement the protocol correctly and agree on the resulting state transitions. This section covers the full workflow:
