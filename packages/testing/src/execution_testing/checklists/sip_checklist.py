"""
SIP Testing Checklist Enum definitions.

Note: This module includes a companion .pyi stub file that provides mypy type
hints for making SIPChecklist classes callable. The stub file is auto-generated
using: uv run generate_checklist_stubs

If you modify the SIPChecklist class structure, regenerate the stub file to
...
class ChecklistItemMeta(type):
    ...
    def __call__(cls, *args, **kwargs):
        ...
        if len(args) == 1 and len(kwargs) == 0 and callable(args[0]):
            func = args[0]
            marker = pytest.mark.sip_checklist(cls._path)
            return marker(func)
        # Otherwise, return a pytest mark decorator
        return pytest.mark.sip_checklist(cls._path, *args, **kwargs)
...
class SIPChecklist:
    """
    Main namespace for SIP testing checklist items.

    This class provides a structured way to reference checklist items for SIP
    ...
    class TransactionType(ChecklistItem):
        ...
        class Test(ChecklistItem):
            ...
            class BlockInteractions(ChecklistItem):
                ...
                class Sip7825(ChecklistItem):
                    """SIP-7825 gas limit tests."""

                    class Invalid(ChecklistItem):
                        """Exceeds SIP-7825 limit."""

                        pass

                    class Valid(ChecklistItem):
                        """Within SIP-7825 limit."""
    ...
    class BlobCountChanges(ChecklistItem):
        ...
        class Test(ChecklistItem):
            ...
            class Sip4844BlobsChanges(ChecklistItem):
                """SIP-4844 blobs test updates."""
