...
from sila import trace
from sila.exceptions import InvalidBlock, SilaException
from sila.fork_criteria import ByBlockNumber, ByTimestamp, Unscheduled
from sila_spec_tools.forks import (
    ForkOverrides,
    Hardfork,
    TemporaryHardfork,
)
...
from sila_spec_tools.utils import get_stream_logger, resolve_fork
...
class T8N(Load):
    ...
    def __init__(
        ...
        *,
        ...
        # of the original ``src/sila/forks/<fork>/`` source.
    ...
    def convert_transaction(self, tx: "TestingTransaction") -> Any:
        ...
        # Bridge testing-side aliases (gsil-compatible) to the names
    ...
    def pay_block_rewards(self, block_reward: U256, block_env: Any) -> None:
        ...
        self.fork.create_sila(rewards_state, block_env.coinbase, miner_reward)
    ...
    def _process_txs(self, block_env: Any, block_output: Any) -> None:
        ...
        for tx_index, testing_tx in enumerate(self.txs):
            ...
            except (SilaException, UnsupportedTxError) as e:
    ...
    def _run_blockchain_test(self, block_env: Any, block_output: Any) -> None:
        ...
        # SIP-7928: Post-execution operations use index N+1
        ...
        if self.fork.has_hash_block_access_list:
            ...
            # Validate block access list gas limit constraint (SIP-7928)
