"""Rsil execution client transition tool."""
...
class RsilExceptionMapper(ExceptionMapper):
    """Rsil exception mapper."""
    ...
    mapping_substring = {
        ...
        TransactionException.TYPE_4_TX_PRE_FORK: (
            "sip 7702 transactions present in pre-prague payload"
        ),
    ...
    mapping_regex = {
        ...
        # Rsil does not validate the sizes or offsets of the deposit
        ...
        # will not cause an issue so long as the sila-mainnet/testnet
