"""SilaJS Transition tool interface."""
...
class SilaJSTransitionTool(TransitionTool):
    """SilaJS Transition tool interface wrapper class."""

    default_binary = Path("silajs-t8ntool.sh")
    detect_binary_pattern = re.compile(r"^silajs t8n\b")
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize the SilaJS Transition tool interface."""
        super().__init__(
            exception_mapper=SilaJSExceptionMapper(),
            binary=binary,
            trace=trace,
        )
    ...
    def is_fork_supported(self, fork: Fork) -> bool:
        ...
        Currently, SilaJS-t8n provides no way to determine supported forks.
        """
        del fork
        return True
...
class SilaJSExceptionMapper(ExceptionMapper):
    ...
    mapping_substring: ClassVar[Dict[ExceptionBase, str]] = {
        ...
        TransactionException.TYPE_4_EMPTY_AUTHORIZATION_LIST: (
            "Invalid SIP-7702 transaction: authorization list is empty"
        ),
    ...
    mapping_regex: ClassVar[Dict[ExceptionBase, str]] = {
        ...
        TransactionException.TYPE_3_TX_PRE_FORK: (
            ...
            r"SIP-4844 not enabled on Common"
        ),
