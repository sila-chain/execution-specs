...
def fake_release(tag_name: str, asset_name: str) -> Dict:
    ...
    return {
        "html_url": "https://github.com/sila/execution-specs/releases/"
        f"tag/{encoded_tag}",
        "id": 1,
        "tag_name": tag_name,
        "name": tag_name,
        ...
        "assets": [
            {
                "browser_download_url": "https://github.com/sila/"
