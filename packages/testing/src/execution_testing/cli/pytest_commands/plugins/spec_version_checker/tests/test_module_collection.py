"""Test which test modules the SIP version checker collects."""
...
VERSION_CHECK_ITEM = "*/sip9999_example/test_example.py::test_sip_spec_version"

CHECK_SIP_VERSIONS_INI = (
...
MODULE_HEADER = textwrap.dedent(
    ...
    REFERENCE_SPEC_GIT_PATH = "SIPS/sip-9999.md"
...
def collect_version_checks(
    ...
    """Collect the version checks for an SIP module holding `test_source`."""
    pytester.makepyfile(
        **{"tests/sip9999_example/test_example": MODULE_HEADER + test_source}
    )
    pytester.copy_example(name=CHECK_SIP_VERSIONS_INI)
