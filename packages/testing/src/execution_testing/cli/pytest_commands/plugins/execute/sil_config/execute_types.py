...
class AddressOverrideDict(SilaTestRootModel):
    """
...
class ForkActivationTimes(SilaTestRootModel[Dict[Fork, int]]):
...
class NetworkConfig(CamelModel):
    ...
    def get_sil_config(self, current_time: int) -> SilConfigResponse:
        ...
        return SilConfigResponse(**kwargs)


class NetworkConfigFile(SilaTestRootModel):
...
class GenesisConfig(CamelModel):
    """Config model contained in a Gsil-type genesis file."""
