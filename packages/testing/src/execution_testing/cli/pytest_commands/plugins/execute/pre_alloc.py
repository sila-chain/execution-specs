...
def _compute_deploy_gas_limit(
    ...
    *,
    ...
    # SIP-7825 execution-gas cap over it: when the unbuffered estimate
    # still fits
...
class Alloc(SharedAlloc):
    ...
    def verify_deployed_accounts(self, block_number: int) -> None:
        ...
        Batches sil_getBalance and sil_getTransactionCount queries.
        Fetches code only for assertions with code_prefix (e.g., SIP-7702
        ...
        for i in range(0, len(deferred), chunk):
            ...
            accounts = self._sil_rpc.get_alloc(
