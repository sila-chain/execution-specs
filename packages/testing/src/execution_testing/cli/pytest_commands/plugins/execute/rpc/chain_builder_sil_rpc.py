"""
Chain builder Sila RPC that can drive the chain when new transactions are
submitted.
"""
...
from execution_testing.rpc import SilRPC as BaseEthRPC
...
class ChainBuilderEthRPC(BaseEthRPC, namespace="sil"):
    """
    Special type of Sila RPC client that also has access to the Engine API
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize the Sila RPC client for the hive simulator."""
        super().__init__(
            rpc_endpoint,
        ...
        base_name = f"sil_rpc_forkchoice_updated_{parsed.hostname}"
    ...
    def send_transactions(
        ...
        ``testing_buildBlockV1`` instead of ``sil_sendRawTransaction``.
        """
