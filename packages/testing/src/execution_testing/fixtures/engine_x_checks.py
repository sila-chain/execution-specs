...
# Placeholder for the masked SIP-2935 parent-hash write in a BAL.
...
def _comparable_bal(bal: Bytes, parent_hash: Hash) -> Any:
    """
    Return the decoded BAL with the SIP-2935 history write masked.

    The SIP-2935 system call writes the block's parent hash into the
...
def verify_engine_x_execution(output_dir: Path) -> EngineXCheckResult:
    ...
    SIP-2935 history write of its own parent hash masked out, see
    `_comparable_bal`.
