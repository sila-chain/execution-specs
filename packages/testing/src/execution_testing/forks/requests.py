...
aggregates them into the SIP-7685 requests hash. A `SystemContractRequest`
...
request classes next to the SIP that introduces them.
"""
...
class FeeSystemContractRequest(SystemContractRequest):
    ...
    SIP-7002 predeploy: excess, count, queue head and queue tail each take a
