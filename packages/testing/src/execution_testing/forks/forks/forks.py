...
class Frontier(BaseFork):
    ...
    def _call_access_cost(cls, opcode: OpcodeBase, gas_costs: GasCosts) -> int:
        ...
        Flat before SIP-2929 introduces warm and cold pricing.
        """
        del opcode
    ...
    def _selfdestruct_access_cost(
        ...
        Zero before SIP-2929 introduces warm and cold pricing.
        """
    ...
    def _calculate_call_gas(
        ...
        # They are independent until SIP-161 couples the new account
