"""
SIP-150: Gas cost changes for IO-heavy operations.
...
class SIP150(BaseFork):
    ...
    def _calculate_selfdestruct_gas(
        ...
        """Charge for beneficiary creation, introduced by SIP-150."""
        base_cost = super(SIP150, cls)._calculate_selfdestruct_gas(
            opcode, gas_costs
        )
