...
class SIP3860(BaseFork):
    ...
    def transaction_intrinsic_cost_calculator(
        ...
        """
        super_fn = super(SIP3860, cls).transaction_intrinsic_cost_calculator()
    ...
    def _calculate_create_gas(
        ...
        base_cost = super(SIP3860, cls)._calculate_create_gas(
            opcode, gas_costs
        )
    ...
    def _calculate_create2_gas(
        ...
        base_cost = super(SIP3860, cls)._calculate_create2_gas(
            opcode, gas_costs
        )
