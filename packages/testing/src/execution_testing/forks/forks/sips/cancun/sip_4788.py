...
class SIP4788(BaseFork):
    ...
    def empty_block_bal_item_count(cls) -> int:
        ...
        return super(SIP4788, cls).empty_block_bal_item_count() + 3
    ...
    def system_contract_call_phases(cls) -> Mapping[Address, SystemCallPhase]:
        ...
        return {
            ...
            **super(SIP4788, cls).system_contract_call_phases(),
        }
    ...
    def pre_allocation_blockchain(cls) -> Mapping:
        ...
        return {
            ...
            **super(SIP4788, cls).pre_allocation_blockchain(),
        }
