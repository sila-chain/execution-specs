...
class SIP2780(BaseFork):
    ...
    def gas_costs(cls) -> GasCosts:
        ...
        """
        parent = super(SIP2780, cls).gas_costs()
        return replace(
            parent,
            TX_BASE=12_000,
            TX_VALUE_COST=6_000,
    ...
    def transaction_data_floor_cost_calculator(
        ...
        """
        super_fn = super(SIP2780, cls).transaction_data_floor_cost_calculator()
    ...
    def transaction_intrinsic_cost_calculator(
        ...
        """
        super_fn = super(SIP2780, cls).transaction_intrinsic_cost_calculator()
        gas_costs = cls.gas_costs()
        ...
        def fn(
            *,
            ...
            if contract_creation:
                # SIP-2780: the created account's NEW_ACCOUNT state gas
    ...
    def refund_types(cls) -> List[RefundTypes]:
        ...
        return [
            refund
            for refund in super(SIP2780, cls).refund_types()
