...
class SIP8037(BaseFork):
    ...
    def _calculate_create_state_gas(
        ...
        `NEW_ACCOUNT`. Before SIP-8037 this was folded into
        `OPCODE_CREATE_BASE`. Under SIP-8037 it is exposed here so that
    ...
    def _calculate_selfdestruct_state_gas(
        ...
        folded into the regular SELFDESTRUCT cost; under SIP-8037 it is
    ...
    def _calculate_selfdestruct_gas(
        ...
        cost; the SIP-8038 `ACCOUNT_WRITE` surcharge stays in regular gas.
        """
