"""
SIP-7981: Increase Access List Cost.
...
class SIP7981(BaseFork):
    ...
    def _access_list_data_cost(
        ...
        SIP-7976 floor rate. Add this surcharge to both the intrinsic
    ...
    def transaction_data_floor_cost_calculator(
        ...
        """
        super_fn = super(SIP7981, cls).transaction_data_floor_cost_calculator()
    ...
    def transaction_intrinsic_cost_calculator(
        ...
        """
        super_fn = super(SIP7981, cls).transaction_intrinsic_cost_calculator()
