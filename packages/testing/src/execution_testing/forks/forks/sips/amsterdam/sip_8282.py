...
Predeploy builder deposit and exit request contracts for SIP-7732 builders on
the SIP-7685 request bus.
...
class SIP8282(BaseFork):
    ...
    def empty_block_bal_item_count(cls) -> int:
        ...
        return super(SIP8282, cls).empty_block_bal_item_count() + 10
