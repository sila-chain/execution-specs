...
class BuilderDepositRequest(FeeSystemContractRequest):
    """
    Builder deposit request (SIP-8282).

    Serves both a builder's first deposit and stake top-ups. The request pays
    the shared SIP-1559-style fee on top of the staked `amount`, so its call
...
class SIP8282(BaseFork):
    ...
    def system_contracts(cls) -> List[Address]:
        ...
        ] + super(SIP8282, cls).system_contracts()
    ...
    def system_contract_call_phases(cls) -> Mapping[Address, SystemCallPhase]:
        ...
        return {
            ...
            **super(SIP8282, cls).system_contract_call_phases(),
        }
    ...
    def system_contract_request_types(
        ...
        return (
            request_types + super(SIP8282, cls).system_contract_request_types()
        )
    ...
    def pre_allocation_blockchain(cls) -> Mapping:
        ...
        return {
            ...
            **super(SIP8282, cls).pre_allocation_blockchain(),
        }
