...
class DepositRequest(SystemContractRequest):
    """Deposit request (SIP-6110), read from the deposit contract's log."""
...
class SIP6110(BaseFork):
    ...
    def system_contract_call_phases(cls) -> Mapping[Address, SystemCallPhase]:
        ...
        return {
            ...
            **super(SIP6110, cls).system_contract_call_phases(),
        }
    ...
    def pre_allocation_blockchain(cls) -> Mapping:
        ...
        return {
            ...
            **super(SIP6110, cls).pre_allocation_blockchain(),
        }
