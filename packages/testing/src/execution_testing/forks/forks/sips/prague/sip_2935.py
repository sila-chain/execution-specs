...
class SIP2935(BaseFork):
    ...
    def empty_block_bal_item_count(cls) -> int:
        ...
        return super(SIP2935, cls).empty_block_bal_item_count() + 2
    ...
    def system_contracts(cls) -> List[Address]:
        ...
        ] + super(SIP2935, cls).system_contracts()
    ...
    def system_contract_call_phases(cls) -> Mapping[Address, SystemCallPhase]:
        ...
        return {
            ...
            **super(SIP2935, cls).system_contract_call_phases(),
        }
    ...
    def pre_allocation_blockchain(cls) -> Mapping:
        ...
        return {
            ...
            **super(SIP2935, cls).pre_allocation_blockchain(),
        }
