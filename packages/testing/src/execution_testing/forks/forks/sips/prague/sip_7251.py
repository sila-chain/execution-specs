...
class ConsolidationRequest(FeeSystemContractRequest):
    """Consolidation request (SIP-7251)."""
...
class SIP7251(BaseFork):
    ...
    def empty_block_bal_item_count(cls) -> int:
        ...
        return (
            super(SIP7251, cls).empty_block_bal_item_count()
    ...
    def system_contract_call_phases(cls) -> Mapping[Address, SystemCallPhase]:
        ...
        return {
            ...
            **super(SIP7251, cls).system_contract_call_phases(),
        }
    ...
    def pre_allocation_blockchain(cls) -> Mapping:
        ...
        return {
            ...
            **super(SIP7251, cls).pre_allocation_blockchain(),
        }
