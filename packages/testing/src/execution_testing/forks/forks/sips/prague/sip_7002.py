...
class SIP7002(BaseFork):
    ...
    def empty_block_bal_item_count(cls) -> int:
        ...
        return (
            super(SIP7002, cls).empty_block_bal_item_count()
    ...
    def system_contract_call_phases(cls) -> Mapping[Address, SystemCallPhase]:
        ...
        return {
            ...
            **super(SIP7002, cls).system_contract_call_phases(),
        }
    ...
    def pre_allocation_blockchain(cls) -> Mapping:
        ...
        return {
            ...
            **super(SIP7002, cls).pre_allocation_blockchain(),
        }
