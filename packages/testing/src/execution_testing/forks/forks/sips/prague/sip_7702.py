...
class SIP7702(BaseFork):
    ...
    def _calculate_call_gas(
        ...
        base_cost = super(SIP7702, cls)._calculate_call_gas(opcode, gas_costs)
    ...
    def transaction_intrinsic_cost_calculator(
        ...
        """
        super_fn = super(SIP7702, cls).transaction_intrinsic_cost_calculator()
