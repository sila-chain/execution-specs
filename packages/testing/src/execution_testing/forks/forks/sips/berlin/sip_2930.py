"""
SIP-2930: Optional access lists.
...
class SIP2930(BaseFork):
    ...
    def transaction_intrinsic_cost_calculator(
        ...
        """
        super_fn = super(SIP2930, cls).transaction_intrinsic_cost_calculator()
