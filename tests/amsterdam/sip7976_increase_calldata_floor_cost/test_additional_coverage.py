...
class TestTokenCalculation:
    ...
    def test_token_calculation_verification(
        ...
        Floor token formula introduced in SIP-7976:
        ...
        # SIP-2780 anchors the floor on the decomposed intrinsic base,
        ...
        if fork.is_sip_enabled(2780):
            # SIP-2780 surfaces an explicit recipient-access charge for
...
class TestMaximumCalldata:
    ...
    def test_maximum_calldata_size(
        ...
        # (below the default block gas limit to avoid SIP-7825 cap issues)
...
class TestExactThresholdBoundary:
    ...
    @pytest.mark.parametrize(
        "ty",
        [
            # Type 1 (SIP-2930) introduced access lists
...
class TestAuthorizationListGasCost:
    ...
    def test_authorization_list_intrinsic_gas(
        ...
        """
        Verify the authorization-list intrinsic cost under SIP-2780.
        ...
        the SIP-7623 calldata floor is applied) the per-authorization
