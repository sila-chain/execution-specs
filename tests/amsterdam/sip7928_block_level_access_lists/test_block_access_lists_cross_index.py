"""
Tests for SIP-7928 BAL cross-index tracking.
...
from ...prague.sip7251_consolidations.spec import Spec as Spec7251
...
def test_bal_intra_tx_round_trip_after_prior_tx_write(
    ...
    Per SIP-7928 §Storage, a write is compared against "the storage value
...
def test_bal_withdrawal_predeploy_balance_observed_cross_tx(
    ...
    Per SIP-7928, the BAL prefix consumed by tx 1's execution must include
