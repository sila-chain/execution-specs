"""Tests for the effects of SIP-4895 withdrawals on SIP-7928."""
...
def test_bal_withdrawal_and_transaction(
    ...
    Alice starts with 1 SIL, Bob starts with 0, Charlie starts with 0.
...
def test_bal_withdrawal_and_value_transfer_same_address(
    ...
    Alice starts with 1 SIL, Bob starts with 0.
