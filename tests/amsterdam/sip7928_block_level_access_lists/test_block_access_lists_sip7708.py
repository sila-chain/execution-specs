"""
Cross-SIP tests for SIP-7928 block-level access lists and SIP-7708
transfer logs.

A single block pins both views of the same value flows: the receipts
carry the SIP-7708 Transfer logs while the block access list carries the
...
from ..sip7708_sil_transfer_logs.spec import Spec as Spec7708
    ...
    block = Block(
        ...
        expected_block_access_list=BlockAccessListExpectation(
            account_expectations={
                ...
                # System address MUST NOT be included: SIP-7708 emits
