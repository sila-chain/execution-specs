"""Tests for the effects of SIP-2935 historical block hashes on SIP-7928."""
...
from tests.cancun.sip4788_beacon_root.spec import Spec as Spec4788
from tests.prague.sip2935_historical_block_hashes_from_state.spec import Spec
...
def test_bal_2935_invalid_calldata_size(
    ...
    """
    Ensure BAL correctly handles SIP-2935 queries with invalid calldata size.

    SIP-2935 requires exactly 32 bytes of calldata. Any other size causes
...
def test_bal_2935_absent_contract(
    ...
    with an empty AccountChanges. Unreachable on sila-mainnet,
...
def test_bal_2935_blockhash_does_not_read_history(
    ...
    SIP-2935 lets a client answer `BLOCKHASH` out of this contract's
