"""Tests for the effects of SIP-7251 consolidation requests on SIP-7928."""
...
from tests.prague.sip7251_consolidations.helpers import ConsolidationRequest
from tests.prague.sip7251_consolidations.spec import Spec, ref_spec_7251
...
def test_bal_system_dequeue_consolidations_sip7251(
