"""Tests for the effects of SIP-4788 beacon roots on SIP-7928."""
...
from tests.cancun.sip4788_beacon_root.spec import Spec, SpecHelpers
...
def test_bal_4788_invalid_calldata_size(
    ...
    """
    Ensure BAL correctly handles SIP-4788 queries with invalid calldata size.

    SIP-4788 requires exactly 32 bytes of calldata (a timestamp). Any other
...
def test_bal_4788_noop_writes_are_reads(
    ...
    # SIP-4788 lets a client write these slots without running the
