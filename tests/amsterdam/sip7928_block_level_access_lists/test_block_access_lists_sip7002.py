"""Tests for the effects of SIP-7002 transactions on SIP-7928."""
...
from ...prague.sip7002_el_triggerable_withdrawals.helpers import (
    WithdrawalRequest,
)
from ...prague.sip7002_el_triggerable_withdrawals.spec import Spec as Spec7002
...
def test_bal_7002_partial_sweep(
    ...
    sip7002_address = Address(Spec7002.WITHDRAWAL_REQUEST_PREDEPLOY_ADDRESS)
    ...
    block_1_expectations[sip7002_address] = BalAccountExpectation(
    ...
    block_2_expectations = {
        sip7002_address: BalAccountExpectation(
...
def test_bal_7002_no_withdrawal_requests(
    ...
    """
    Ensure BAL captures SIP-7002 system contract dequeue operation even
...
def test_bal_7002_request_from_contract(
    ...
    Alice calls RelayContract which internally calls SIP-7002 system
