"""Tests for SIP-7928 using the consistent data class pattern."""
...
def test_bal_code_changes(
    ...
    factory_code = (
        ...
        + Op.PUSH1(0x00)  # value = 0 (no SIL sent)
...
def test_bal_cross_tx_factory_nonce_create_chain(
    ...
    for s in sequence:
        ...
        if s["deployed"]:
            ...
            # Collision: accessed during SIP-684 check, no state change.
...
def test_bal_all_transaction_types(
    ...
    Types: Legacy, SIP-2930, SIP-1559, Blob, SIP-7702.
    ...
    sender_2 = pre.fund_eoa()  # Type 2 - SIP-1559
    sender_3 = pre.fund_eoa()  # Type 3 - Blob
    sender_4 = pre.fund_eoa()  # Type 4 - SIP-7702
    ...
    # For Type 4 (SIP-7702): Alice delegates to Oracle
    alice = pre.fund_eoa()
    ...
    # TX2: Type 1 - Access List transaction (SIP-2930)
    ...
    # TX3: Type 2 - SIP-1559 Dynamic fee transaction
    ...
    # TX4: Type 3 - Blob transaction (SIP-4844)
    ...
    # TX5: Type 4 - SIP-7702 Set Code transaction
