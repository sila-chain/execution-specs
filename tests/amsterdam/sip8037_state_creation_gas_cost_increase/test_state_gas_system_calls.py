"""Test the independent gas budgets of SIP-8037 protocol system calls."""
...
from ...cancun.sip4788_beacon_root.spec import Spec as BeaconSpec
from ...prague.sip2935_historical_block_hashes_from_state.spec import (
    Spec as HistorySpec,
)
