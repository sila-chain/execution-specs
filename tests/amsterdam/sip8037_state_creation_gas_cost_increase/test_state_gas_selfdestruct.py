"""
Test SELFDESTRUCT state gas charging under SIP-8037.
...
def test_selfdestruct_state_gas_refilled_on_ancestor_revert(
    ...
    rolls back and the spilled state charge is refilled. The SIP-8038
...
def test_selfdestruct_pre_existing_account_no_refund(
    ...
    # Per SIP-6780, SELFDESTRUCT on a not-same-tx-created account
