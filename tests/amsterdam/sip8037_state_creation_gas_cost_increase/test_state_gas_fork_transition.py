...
def test_tx_gas_above_cap_at_transition(
    ...
    """
    Test tx.gas > TX_MAX_GAS_LIMIT validity at the SIP-8037 transition.

    Before SIP-8037, SIP-7825 rejects any tx with gas > TX_MAX_GAS_LIMIT.
    After SIP-8037 it's allowed — the excess feeds the state gas
    ...
    # Before fork: above-cap tx is rejected by SIP-7825
    before_error = (
