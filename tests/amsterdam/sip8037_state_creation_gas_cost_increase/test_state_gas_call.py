"""
Test CALL state gas reservoir passing under SIP-8037.
...
def test_call_value_to_pre_existing_selfdestructed_account(
    ...
    Per SIP-6780 a pre existing contract that executes SELFDESTRUCT
...
def test_call_value_new_account_state_gas_consumed_on_caller_halt(
    ...
    the SIP-7825 gas cap over-cap (the restored reservoir is refunded). The
    ...
    if reservoir == "over_cap":
        # The excess over the SIP-7825 cap becomes the reservoir.
