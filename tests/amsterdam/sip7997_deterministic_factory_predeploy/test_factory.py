"""
Tests for [SIP-7997: Deterministic Factory Predeploy](https://sips.sila.org/SIPS/sip-7997).
...
pytestmark = pytest.mark.valid_from("SIP7997")
...
def test_factory_via_sip7702_delegation(
    ...
    """
    An EOA delegates its code to the factory via an SIP-7702
...
def test_factory_rejects_ef_prefix_deployment(
    ...
    """
    SIP-3541: deploying code that begins with `0xEF` is rejected. The
...
def test_factory_rejects_oversized_initcode(
    ...
    """
    SIP-3860: initcode larger than the fork's max initcode size is
...
def test_factory_block_access_list(
    ...
    """
    SIP-7928: a factory deployment is captured in the block-level
