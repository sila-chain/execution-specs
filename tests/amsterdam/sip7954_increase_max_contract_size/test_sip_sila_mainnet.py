...
pytestmark = [pytest.mark.valid_at("SIP7954"), pytest.mark.sila_mainnet]
...
def test_over_max_code_size_sila_mainnet(
    ...
    """Verify deployment above the new limit is rejected on sila-mainnet."""
...
def test_over_max_initcode_size_sila_mainnet(
    state_test: StateTestFiller,
    pre: Alloc,
    fork: Fork,
) -> None:
...
def test_max_code_size_with_max_initcode_sila_mainnet(
    state_test: StateTestFiller,
    pre: Alloc,
    fork: Fork,
    ...
    """
    Verify max-size contract works on sila-mainnet.
