"""
Tests for the SIP-7702 authorization *regular*-gas refund under
...
* the **state** channel: ``StateGasCosts.NEW_ACCOUNT`` is refilled into
  ...
  **not** subject to the SIP-3529 one-fifth cap. This channel is the
  subject of the SIP-8037 ``sip8037_state_creation_gas_cost_increase``
  suite.
...
def test_existing_authority_regular_refund_visible(
    ...
    to the SIP-8037 suite and is only used here to size the receipt.
    """
