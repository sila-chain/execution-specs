...
Covers the SIP-8038 access-list repricing:
...
def _access_list_floor_token_gas(
    ...
    """
    Return the SIP-7981 calldata-floor-token gas the Amsterdam intrinsic
    ...
    the measured intrinsic delta isolates the pure SIP-8038 per-entry
    surcharge.
    """
    total_bytes = 0
...
def test_access_list_intrinsic_surcharge(
    ...
    SIP-7981 floor-token contribution, must equal
