...
def test_same_tx_created_selfdestruct_self_burn(
    ...
    No net state gas is charged either way: under SIP-2780 the create-tx
    ...
    # Creation intrinsic is execution-only under SIP-2780; the pre-existing
...
def test_same_tx_created_selfdestruct_to_fresh_beneficiary(
    ...
    # not part of the intrinsic under SIP-2780; only the fresh
