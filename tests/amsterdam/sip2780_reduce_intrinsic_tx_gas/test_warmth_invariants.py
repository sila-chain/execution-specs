"""
SIP-2780 invariants for transaction-level account charges.
...
def test_top_frame_charges_delegation_in_access_list(
    ...
    """
    Recipient holds a pre-existing SIP-7702 delegation; the delegation
...
def test_top_frame_charges_self_delegation_oog(
    ...
    """
    Recipient holds a pre-existing SIP-7702 delegation pointing back at
    ...
    read to discover the delegation: per SIP-7928 it must appear in the
