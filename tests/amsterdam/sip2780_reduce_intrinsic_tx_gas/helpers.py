"""Shared helpers for SIP-2780 tests."""
...
class AuthorizationAction(Enum):
    """The action an SIP-7702 authorization performs on its authority."""
...
class AuthorizationScenario:
    """
    An SIP-7702 authorization togsiler with the authority it acts on and
