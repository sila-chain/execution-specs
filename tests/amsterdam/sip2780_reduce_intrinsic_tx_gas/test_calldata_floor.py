"""SIP-2780 interaction with the SIP-7623/7976 calldata floor."""
...
from ...prague.sip7623_increase_calldata_cost.helpers import (
...
def _floor_dominating_calldata(fork: Fork) -> Bytes:
    ...
    Reuses the shared SIP-7623 ``find_floor_cost_threshold`` binary
...
def test_calldata_floor(
    ...
    - ``below_floor``: a gas limit one short of the floor still covers
      ...
      SIP-2780-lowered ``TX_BASE`` -- is the only thing that can reject
