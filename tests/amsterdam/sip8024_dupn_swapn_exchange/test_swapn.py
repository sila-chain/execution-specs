...
@SIPChecklist.Opcode.Test.StackComplexOperations.DataPortionVariables.Bottom()
...
@SIPChecklist.Opcode.Test.DataPortion.AllZeros()
@SIPChecklist.Opcode.Test.DataPortion.MaxValue()
@pytest.mark.parametrize(
    "immediate",
    [0, 45, 90, 128, 200, 255],
...
@SIPChecklist.Opcode.Test.ExceptionalAbort()
@pytest.mark.parametrize(
    "invalid_immediate",
...
def test_swapn_invalid_immediate_aborts(
    ...
    Per SIP-8024, immediate values in range [91, 127] (0x5b-0x7f) are
...
def test_endofcode_behavior(
    ...
    Per SIP-8024, code[pc + 1] evaluates to 0 if beyond the end of the code,
...
@SIPChecklist.Opcode.Test.DataPortion.Jump()
def test_swapn_jump_to_immediate_byte_0x5b_succeeds(
    ...
    Per SIP-8024, 0x5b is preserved as valid JUMPDEST for compatibility.
...
def test_swapn_jump_to_valid_immediate_fails(
    ...
    JUMPDEST analysis is unchanged by SIP-8024: position 4 holds 0x00,
...
@SIPChecklist.Opcode.Test.StackComplexOperations.DataPortionVariables.Top()
@SIPChecklist.Opcode.Test.StackComplexOperations.DataPortionVariables.Middle()
@pytest.mark.parametrize(
    "stack_index",
    [17, 126, 235],
