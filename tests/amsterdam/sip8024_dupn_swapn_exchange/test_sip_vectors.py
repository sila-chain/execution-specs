...
def test_sip_vector_dupn_duplicate_bottom(
    pre: Alloc,
    state_test: StateTestFiller,
) -> None:
    """
    SIP test vector: 60016000808080808080808080808080808080e680.
    ...
    # Build the exact bytecode from the SIP
...
def test_sip_vector_swapn_swap_with_bottom(
    pre: Alloc,
    state_test: StateTestFiller,
) -> None:
    """
    SIP test vector: 600160008080808080808080808080808080806002e780.
...
def test_sip_vector_exchange_swap_positions(
    pre: Alloc,
    state_test: StateTestFiller,
) -> None:
    """
    SIP test vector: 600060016002e88e.
...
def test_sip_vector_swapn_invalid_immediate_reverts(
    pre: Alloc,
    state_test: StateTestFiller,
) -> None:
    """
    SIP test vector: e75b reverts.
    ...
    # Build the exact bytecode from the SIP: SWAPN[0x5b]
...
def test_sip_vector_jump_over_invalid_dupn(
    pre: Alloc,
    state_test: StateTestFiller,
) -> None:
    """
    SIP test vector: 600456e65b executes successfully.
...
def test_sip_vector_exchange_with_iszero(
    pre: Alloc,
    state_test: StateTestFiller,
) -> None:
    """
    SIP test vector: 60008080e88e15.
...
def test_sip_vector_dupn_stack_underflow(
    pre: Alloc,
    state_test: StateTestFiller,
) -> None:
    """
    SIP test vector: 6000808080808080808080808080808080e680.
...
def test_sip_vector_exchange_end_of_code(
    pre: Alloc,
    state_test: StateTestFiller,
) -> None:
    """
    SIP test vector: 600260008080808080600160008080808080808080e8.
    ...
    # Build exact bytecode from the SIP
    code = (
        Op.PUSH1[0x2]
        + Op.PUSH1[0x0]
        + Op.DUP1 * 5
...
def test_sip_vector_exchange_30_items(
    pre: Alloc,
    state_test: StateTestFiller,
) -> None:
    """
    SIP test vector (30-item EXCHANGE).
...
def test_vector_push_in_immediate_masks_jumpdest(
    ...
    is unchanged by SIP-8024: the byte after the opcode is analyzed as
...
def test_sip_vector_end_of_code(
    pre: Alloc,
    state_test: StateTestFiller,
    sip8024_opcode: Op,
    stack_items: int,
    ...
    """
    Test SIP-8024 opcodes at end of code (no immediate byte).
