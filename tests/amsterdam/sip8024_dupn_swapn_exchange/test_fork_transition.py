"""Fork-transition tests for SIP-8024 (DUPN, SWAPN, EXCHANGE)."""
...
@pytest.mark.valid_at_transition_to("SIP8024")
...
def test_opcode_at_fork_transition(
    ...
    """
    Test DUPN/SWAPN/EXCHANGE behavior across the SIP-8024 fork transition.
...
def test_jumpdest_in_immediate_at_fork_transition(
    ...
    """
    Test a JUMPDEST inside an SIP-8024 immediate across the transition.

    JUMPDEST analysis is unchanged by SIP-8024, so the 0x5b byte in the
