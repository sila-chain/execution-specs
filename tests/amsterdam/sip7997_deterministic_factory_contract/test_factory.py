...
pytestmark = [
    pytest.mark.valid_from("SIP7997"),
    pytest.mark.execute(
        pytest.mark.skip(
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            1,
            id="with_value",
            marks=SIPChecklist.SystemContract.Test.ValueTransfer.NoFee(),
        ),
    ],
)
@SIPChecklist.SystemContract.Test.CallContexts.Normal()
@SIPChecklist.SystemContract.Test.Inputs.Valid()
...
def test_factory_address_collision_reverts(
    ...
    SELFDESTRUCT schedules deletion at transaction end under SIP-6780.
    Until then the code and nonce still prevent another creation, including
    under SIP-8246. Reverting the retry restores the factory nonce.
    """
    salt = 0x77
...
def test_factory_creation_failure_returns_empty_data(
    ...
    Revert the factory nonce increment togsiler with the failed creation.
    """
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            0,
            id="0_bytes",
            marks=SIPChecklist.SystemContract.Test.InputLengths.Zero(),
        ),
        pytest.param(1, id="1_byte"),
        pytest.param(Spec.SALT_SIZE - 1, id="31_bytes"),
    ],
)
@SIPChecklist.SystemContract.Test.InputLengths.Dynamic.TooShort()
@SIPChecklist.SystemContract.Test.Inputs.Invalid.Corrupted()
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(
            ...
            RUNTIME_CODE,
            id="salt_max",
            marks=SIPChecklist.SystemContract.Test.Inputs.MaxValues(),
        ),
        ...
        pytest.param(
            ...
            marks=SIPChecklist.SystemContract.Test.Inputs.AllZeros(),
        ),
    ],
)
@SIPChecklist.SystemContract.Test.Inputs.Boundary()
@SIPChecklist.SystemContract.Test.InputLengths.Dynamic.Valid()
...
@SIPChecklist.SystemContract.Test.InputLengths.Dynamic.TooLong()
...
@SIPChecklist.SystemContract.Test.CallContexts.TxEntry()
...
@SIPChecklist.SystemContract.Test.CallContexts.Static()
...
@SIPChecklist.SystemContract.Test.CallContexts.Delegate()
@SIPChecklist.SystemContract.Test.CallContexts.Callcode()
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            marks=SIPChecklist.SystemContract.Test.CallContexts.Initcode.Tx(),
        ),
        pytest.param(
            "create",
            id="initcode_of_create_opcode",
            marks=(
                SIPChecklist.SystemContract.Test.CallContexts.Initcode.CREATE()
            ),
        ),
        pytest.param(
            "factory",
...
@SIPChecklist.SystemContract.Test.CallContexts.SetCode()
@pytest.mark.parametrize(
    "forwarded_value",
    [
        pytest.param(0, id="no_value"),
...
def test_factory_via_sip7702_delegation(
    state_test: StateTestFiller,
    pre: Alloc,
    forwarded_value: int,
) -> None:
...
@SIPChecklist.SystemContract.Test.Inputs.Invalid(exact=True)
@SIPChecklist.SystemContract.Test.Inputs.Invalid.Checks()
def test_factory_rejects_ef_prefix_deployment(
    state_test: StateTestFiller,
    pre: Alloc,
) -> None:
    """
    Reject deployed code starting with 0xEF under SIP-3541.
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            0,
            id="max",
            marks=SIPChecklist.SystemContract.Test.OutOfBounds.Max(),
        ),
        pytest.param(
            1,
            id="max_plus_one",
            marks=[
                SIPChecklist.SystemContract.Test.OutOfBounds.MaxPlusOne(),
                SIPChecklist.SystemContract.Test.Inputs.Invalid.Checks(),
            ],
        ),
    ],
...
def test_factory_initcode_size_boundary(
    ...
    SIP-3860 raises OutOfGasError in CREATE2 for oversized initcode, which
