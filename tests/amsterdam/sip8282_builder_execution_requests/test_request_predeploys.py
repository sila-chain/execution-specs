...
@SIPChecklist.SystemContract.Test.InputLengths.Zero()
def test_fee_getter(
...
@SIPChecklist.SystemContract.Test.CallContexts.Initcode.Tx()
...
@SIPChecklist.SystemContract.Test.ValueTransfer.Fee.Over()
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            Op.DELEGATECALL,
            id="delegatecall",
            marks=SIPChecklist.SystemContract.Test.CallContexts.Delegate(),
        ),
        pytest.param(
            Op.STATICCALL,
            id="staticcall",
            marks=SIPChecklist.SystemContract.Test.CallContexts.Static(),
        ),
        pytest.param(
            Op.CALLCODE,
            id="callcode",
            marks=SIPChecklist.SystemContract.Test.CallContexts.Callcode(),
        ),
    ],
)
...
@SIPChecklist.SystemContract.Test.InputLengths.Zero()
@SIPChecklist.SystemContract.Test.ValueTransfer.NoFee()
...
@SIPChecklist.SystemContract.Test.GasUsage.Dynamic.Oog()
@SIPChecklist.SystemContract.Test.GasUsage.Dynamic.Exact()
def test_request_gas_boundary(
    ...
    """
    # The predeploy ends with a warm SSTORE, which SIP-2200 rejects unless
...
@SIPChecklist.SystemContract.Test.ExcessiveGas.BlockGas()
def test_requests_exhaust_block_gas(
    ...
    # Under SIP-8037 a block has an execution-gas budget and an equal
