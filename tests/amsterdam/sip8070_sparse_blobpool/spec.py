"""Defines SIP-8070 specification constants and functions."""
...
ref_spec_8070 = ReferenceSpec(
    "SIPS/sip-8070.md", "43c7af020f1641924bed60565fde86f6ad3469df"
)
...
class Spec:
    ...
    """Version byte of a KZG blob versioned hash (SIP-4844)."""
