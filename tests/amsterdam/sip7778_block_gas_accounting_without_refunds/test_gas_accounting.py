...
pytestmark = [pytest.mark.valid_from("SIP7778")]


@SIPChecklist.GasRefundsChanges.Test.ExceptionalAbort.Revertable()
@SIPChecklist.GasRefundsChanges.Test.ExceptionalAbort.Revertable.Revert()
@SIPChecklist.GasRefundsChanges.Test.ExceptionalAbort.Revertable.UpperRevert()
@SIPChecklist.GasRefundsChanges.Test.ExceptionalAbort.Revertable.OutOfGas()
@SIPChecklist.GasRefundsChanges.Test.ExceptionalAbort.Revertable.InvalidOpcode()
...
@SIPChecklist.GasRefundsChanges.Test.CrossFunctional.CalldataCost()
@pytest.mark.parametrize(
    "access_list",
    [
...
def test_varying_calldata_costs(
    ...
    With an access list, the floor also carries the SIP-7981 access-list
    ...
    num_iterations = 200
    # Currently in SIP-7778, the optimal call data is found in about
...
def test_mixed_gas_regimes(
    ...
    # SIP-8037: block gas_used counts only execution gas; the SSTORE-set
