"""Helpers used in SIP-7778 tests."""
...
class RefundTransaction(Transaction):
    ...
    def build(
        ...
        *,
        ...
        # SIP-2780 charges each authorization at the top frame rather
        ...
        # The STORAGE_CLEAR path creates no state; only an SIP-7702
    ...
    def block_gas_used(self) -> int:
        """
        SIP-8037 block gas_used, with the calldata floor binding the execution
        dimension.
        """
        return max(
