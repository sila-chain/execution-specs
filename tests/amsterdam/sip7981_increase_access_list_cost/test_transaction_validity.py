...
def test_insufficient_gas_for_access_list(
    ...
    With SIP-7981, the intrinsic gas must cover:
...
@SIPChecklist.TransactionType.Test.IntrinsicValidity.DataFloorAboveIntrinsicGasCost()
@pytest.mark.exception_test
@pytest.mark.with_all_tx_types(selector=lambda tx_type: tx_type >= 1)
@pytest.mark.parametrize(
...
def test_transactions_without_access_list(
    ...
    SIP-7981 should only affect transactions with non-empty access lists.
    """
    state_test(
        pre=pre,
        post={},
...
@SIPChecklist.TransactionType.Test.ContractCreation()
@SIPChecklist.TransactionType.Test.IntrinsicValidity.To()
@SIPChecklist.TransactionType.Test.IntrinsicValidity.GasLimit.Insufficient()
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            marks=[
                pytest.mark.exception_test,
                SIPChecklist.TransactionType.Test.IntrinsicValidity.ValueZeroInsufficientBalance(),
            ],
        ),
        pytest.param(
            0,
            ...
            marks=SIPChecklist.TransactionType.Test.IntrinsicValidity.ValueZeroSufficientBalance(),
        ),
        pytest.param(
            1,
            -1,
            ...
            marks=[
                pytest.mark.exception_test,
                SIPChecklist.TransactionType.Test.IntrinsicValidity.ValueNonZeroInsufficientBalance(),
            ],
        ),
        pytest.param(
            1,
            ...
            marks=SIPChecklist.TransactionType.Test.IntrinsicValidity.ValueNonZeroSufficientBalance(),
        ),
    ],
)
@pytest.mark.parametrize(
