...
def test_access_list_token_calculation(
    ...
    expected_floor_cost = (
        ...
        + gas_costs.TX_BASE
        # SIP-2780 anchors the floor on the decomposed intrinsic base; the
...
def test_large_access_list_cost(
    ...
    With SIP-7981, large access lists should incur:
    1. Storage access costs (per-address and per-key charges, priced
       at the fork's cold access costs since SIP-8038)
...
def test_duplicate_access_list_entries(
    ...
    According to SIP-2930, non-unique addresses and storage keys are allowed
    and charged multiple times. SIP-7981 should maintain this behavior.
    """
    state_test(
        pre=pre,
        post={},
...
def test_access_list_data_cost_with_execution(
    ...
    SIP-7981 charges the access list data cost as a flat surcharge on
