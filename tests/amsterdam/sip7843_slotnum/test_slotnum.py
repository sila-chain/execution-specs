...
pytestmark = pytest.mark.valid_from("SIP7843")
...
@SIPChecklist.Opcode.Test.ExecutionContext.BlockContext()
...
@SIPChecklist.Opcode.Test.ExecutionContext.Call()
...
def test_slotnum_set_code(
    ...
    """
    Test SLOTNUM inside a set-code delegated account (SIP-7702).
    """
    slot_number = 0xC0FFEE
