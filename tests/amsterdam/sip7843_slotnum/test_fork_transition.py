"""Tests for SIP-7843 fork transition behavior."""
...
@pytest.mark.valid_at_transition_to("SIP7843")
def test_slotnum_at_fork_transition(
    blockchain_test: BlockchainTestFiller,
    pre: Alloc,
) -> None:
    """
    Test SLOTNUM behavior across the SIP-7843 fork transition.

    Before SIP-7843, opcode 0x4B is undefined: execution halts with an
    invalid-opcode exception and consumes all gas, so no SSTORE is observed.

    From SIP-7843 onward, SLOTNUM pushes the block's slot number provided
