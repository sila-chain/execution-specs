...
Ported from:
state_tests/stSIP150Specific/Transaction64Rule_integerBoundariesFiller.yml
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stSIP150Specific/Transaction64Rule_integerBoundariesFiller.yml"  # noqa: E501
    ],
)
