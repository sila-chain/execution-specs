...
Ported from:
state_tests/stSIP150Specific/SuicideToNotExistingContractFiller.json
...
`COLD_ACCOUNT_ACCESS - 2600`, exactly 0 before SIP-8038.
"""
...
def test_suicide_to_not_existing_contract(
    ...
    """Test_suicide_to_not_existing_contract."""
    # SIP-8038 cold account access reprice; 0 before SIP-8038. Charged
