...
Ported from:
state_tests/Cancun/stSIP5656_MCOPY/MCOPY_memory_expansion_costFiller.yml
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/Cancun/stSIP5656_MCOPY/MCOPY_memory_expansion_costFiller.yml"  # noqa: E501
    ],
)
