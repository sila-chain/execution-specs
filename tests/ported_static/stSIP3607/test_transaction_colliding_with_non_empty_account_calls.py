...
Ported from:
state_tests/stSIP3607/transactionCollidingWithNonEmptyAccount_callsFiller.yml
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stSIP3607/transactionCollidingWithNonEmptyAccount_callsFiller.yml"  # noqa: E501
    ],
)
