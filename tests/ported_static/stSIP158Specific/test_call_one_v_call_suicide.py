...
Ported from:
state_tests/stSIP158Specific/CALL_OneVCallSuicideFiller.json
...
SELFDESTRUCTs to the (alive) caller. SIP-8038 reprices the cold account
...
def test_call_one_v_call_suicide(
    ...
    """Test_call_one_v_call_suicide."""
    # SIP-8038 deltas, each 0 before SIP-8037. The CALL pays a cold
