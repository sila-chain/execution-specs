...
Ported from:
state_tests/stSIP158Specific/CALL_OneVCallSuicide2Filler.json
...
SIP-8038 reprices the CALL's cold account access and value transfer,
...
def test_call_one_v_call_suicide2(
    ...
    """Test_call_one_v_call_suicide2."""
    # SIP-8038 deltas, each 0 before SIP-8038. The CALL pays the cold
