...
Ported from:
state_tests/stSIP158Specific/EXTCODESIZE_toEpmtyParisFiller.json
...
SIP-8038 reprices the cold account access and adds a second
...
so each is exactly 0 before SIP-8038.
"""
...
def test_extcodesize_to_epmty_paris(
    ...
    """Test_extcodesize_to_epmty_paris."""
    # SIP-8038 deltas, each 0 before SIP-8038. EXTCODESIZE gains the
