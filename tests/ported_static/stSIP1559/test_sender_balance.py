"""
The execution records the SIP-1559 transaction origin balance to make...
...
Ported from:
state_tests/stSIP1559/senderBalanceFiller.yml
"""
...
def test_sender_balance(
    ...
    """The execution records the SIP-1559 transaction origin balance to..."""
