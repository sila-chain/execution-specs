...
Ported from:
state_tests/Cancun/stSIP1153_transientStorage/10_revertUndoesStoreAfterReturnFiller.yml
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/Cancun/stSIP1153_transientStorage/10_revertUndoesStoreAfterReturnFiller.yml"  # noqa: E501
    ],
)
