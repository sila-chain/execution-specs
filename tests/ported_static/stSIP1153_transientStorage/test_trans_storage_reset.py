...
Ported from:
state_tests/Cancun/stSIP1153_transientStorage/transStorageResetFiller.yml
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/Cancun/stSIP1153_transientStorage/transStorageResetFiller.yml"  # noqa: E501
    ],
)
