...
nested CREATE's SIP-150 grant: the call and the creating frame complete
...
(intrinsic + SIP-8037 top-frame and nested-create state gas + composed
...
def test_create_e_contract_create_ne_contract_in_init_oog_tr(
    ...
    # state gas (SIP-8037), the callee, and the nested creation's peak
    # charge.
    gas_limit = (
    ...
    # The nested CREATE runs while the creator's nonce is 1 (SIP-161),
