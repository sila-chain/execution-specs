...
def test_create_oog_after_init_code_returndata_size(
    ...
    # boundary below comes from the fork's model with no SIP branch.
    ...
    # it, and no SSTORE fits there -- SIP-2200 halts any SSTORE outright
    ...
    tx = Transaction(
        sender=pre.fund_eoa(),
        to=entry,
        # Load-bearing under SIP-8037: with a reservoir the deposit's state
