...
Ported from:
state_tests/stMemExpandingSIP150Calls/CallGoesOOGOnSecondLevelWithMemExpandingCallsFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stMemExpandingSIP150Calls/CallGoesOOGOnSecondLevelWithMemExpandingCallsFiller.json"  # noqa: E501
    ],
)
