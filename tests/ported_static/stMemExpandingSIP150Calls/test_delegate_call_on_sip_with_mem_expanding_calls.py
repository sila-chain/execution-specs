"""
Test_delegate_call_on_sip_with_mem_expanding_calls.

Ported from:
state_tests/stMemExpandingSIP150Calls/DelegateCallOnEIPWithMemExpandingCallsFiller.json
...
intrinsic decomposition and SIP-8038 access repricing. Do not hardcode
...
@pytest.mark.ported_from(
    [
        "state_tests/stMemExpandingSIP150Calls/DelegateCallOnEIPWithMemExpandingCallsFiller.json"  # noqa: E501
    ],
)
