...
Ported from:
state_tests/Cancun/stSIP4844_blobtransactions/emptyBlobhashListFiller.yml
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/Cancun/stSIP4844_blobtransactions/emptyBlobhashListFiller.yml"  # noqa: E501
    ],
)
