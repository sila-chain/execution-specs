...
@manually-enhanced: Do not overwrite. On pre-SIP-8037 forks the loop
drains to the ported child count (created nonce 124); under SIP-8037
with the revised SIP-8038 pricing an iteration is dearer (new-account
...
def test_crashing_transaction(
    ...
    """Replay the attack loop; SIP-8037 shrinks the child count."""
    sender = pre.fund_eoa()
    tx_balance = 1
    initcode = (
