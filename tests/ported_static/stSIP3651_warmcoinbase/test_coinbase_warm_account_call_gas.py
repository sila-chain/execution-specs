...
Ported from:
state_tests/Shanghai/stSIP3651_warmcoinbase/coinbaseWarmAccountCallGasFiller.yml
...
@pytest.mark.ported_from(
    [
        "state_tests/Shanghai/stSIP3651_warmcoinbase/coinbaseWarmAccountCallGasFiller.yml"  # noqa: E501
    ],
)
...
def test_coinbase_warm_account_call_gas(
    ...
    # SIP-8038 charges EXTCODESIZE (d0) and EXTCODECOPY (d1) a second
    # WARM_ACCESS for the account code read; other opcodes are unchanged.
    ext_code_read = d in (0, 1) and fork.is_sip_enabled(8038)
