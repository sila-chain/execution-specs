...
Ported from:
state_tests/Shanghai/stSIP3860_limitmeterinitcode/create2InitCodeSizeLimitFiller.yml
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/Shanghai/stSIP3860_limitmeterinitcode/create2InitCodeSizeLimitFiller.yml"  # noqa: E501
    ],
)
