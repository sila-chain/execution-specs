...
code's metadata-priced cost, and the headroom SIP-2200's minimum-gas gate
...
def test_out_of_gas_contract_creation(
    ...
    # SIP-8037 charges the created account's state gas to the creation
    ...
    # SIP-2200 halts any SSTORE that runs with `CALL_STIPEND` gas or less
