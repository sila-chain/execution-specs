"""
Test_suicide_send_siler_post_death.

Ported from:
state_tests/stSystemOperationsTest/suicideSendSilerPostDeathFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stSystemOperationsTest/suicideSendSilerPostDeathFiller.json"  # noqa: E501
    ],
)
@pytest.mark.valid_from("Cancun")
@pytest.mark.pre_alloc_mutable
def test_suicide_send_siler_post_death(
