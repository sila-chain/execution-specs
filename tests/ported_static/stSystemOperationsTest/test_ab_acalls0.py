...
def predict_final_state(
    ...
    computing each level's SIP-150 grant (both asks are pushed
    ...
    its post-call store (SIP-2200's stipend rule included) halts and
    ...
    including SIP-8037 state gas: with a sub-cap gas limit the state
