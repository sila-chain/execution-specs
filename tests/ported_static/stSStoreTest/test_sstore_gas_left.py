"""
Verify the SIP-2200 (SIP-1706) minimum-gas rule for SSTORE: a non-mutating
...
charge SIP-8037/8038 reprice - binds on every fork. Boundary gas is
...
def test_sstore_gas_left(
    ...
    # SIP-2200 requires that to exceed the stipend.
    ...
    # composite cost so SIP-8037 state gas is covered outright.
