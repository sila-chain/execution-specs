"""
Verify the SIP-3529 refund cap over six storage clears: the sender's final
...
`code.refund` composites), so SIP-8037's repriced stores and any future
...
def test_refund600(
    ...
    """Six storage clears refund gas up to the SIP-3529 cap."""
    code = (
    ...
    # SIP-3529 caps the refund at a fifth of the executed gas.
