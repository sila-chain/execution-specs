...
Ported from:
state_tests/stSIP150singleCodeGasPrices/gasCostMemoryFiller.yml
...
baseline. SIP-8038 reprices `COLD_ACCOUNT_ACCESS` (2600 -> 3000), so
that net cost shifts by `COLD_ACCOUNT_ACCESS - 2600`, derived from the
fork's own constant so it is exactly 0 pre-SIP-8038. The first entry
