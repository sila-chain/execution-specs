...
Ported from:
state_tests/stSIP150singleCodeGasPrices/RawCallCodeGasValueTransferMemoryAskFiller.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stSIP150singleCodeGasPrices/RawCallCodeGasValueTransferMemoryAskFiller.json"  # noqa: E501
    ],
)
...
def test_raw_call_code_gas_value_transfer_memory_ask(
    ...
    post = {
        ...
        target: Account(storage={1: 32308, 2: 0x70AC4}),
    }
