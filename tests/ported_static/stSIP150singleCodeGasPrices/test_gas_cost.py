...
Ported from:
state_tests/stSIP150singleCodeGasPrices/gasCostFiller.yml
...
SIP-8038 reprices state access, so four opcodes shift: `BALANCE` and
...
own constants and is exactly 0 pre-SIP-8038; do not hardcode it.
"""
