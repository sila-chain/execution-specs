...
Ported from:
state_tests/stSIP150singleCodeGasPrices/RawExtCodeCopyGasFiller.json

@manually-enhanced: Do not overwrite. This measures the regular gas
that a single cold `EXTCODECOPY` consumes via `Op.GAS`. SIP-8038
...
`is_sip_enabled(8037)` flag (the registered flag that activates the
