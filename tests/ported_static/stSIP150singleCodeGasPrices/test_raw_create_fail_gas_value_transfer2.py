...
Ported from:
state_tests/stSIP150singleCodeGasPrices/RawCreateFailGasValueTransfer2Filler.json
"""
...
@pytest.mark.ported_from(
    [
        "state_tests/stSIP150singleCodeGasPrices/RawCreateFailGasValueTransfer2Filler.json"  # noqa: E501
    ],
)
