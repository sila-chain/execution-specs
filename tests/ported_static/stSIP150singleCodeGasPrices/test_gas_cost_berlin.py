...
Ported from:
state_tests/stSIP150singleCodeGasPrices/gasCostBerlinFiller.yml
...
SIP-8038 reprices state access, so four opcodes now exceed their old
...
constants and is exactly 0 pre-SIP-8038; do not hardcode it.
"""
...
def test_gas_cost_berlin(
    ...
    # SIP-8038 access repricing; each term is 0 on earlier forks.
