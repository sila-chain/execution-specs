...
Ported from:
state_tests/stSIP2930/manualCreateFiller.yml
...
CREATE-deployed contract. SIP-8037 moves the bulk of the SSTORE-set
...
is exactly 0 pre-SIP-8037 and tracks parameter changes; bake the
...
def test_manual_create(
    ...
    # SIP-8037 SSTORE-set spill into regular gas (empty reservoir).
