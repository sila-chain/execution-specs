...
Ported from:
state_tests/stSIP2930/coinbaseT01Filler.yml
...
already-existing coinbase. SIP-8038 reprices the value-transfer
...
own gas model, so it is exactly 0 before SIP-8038 and tracks future
...
def test_coinbase_t01(
    ...
    # SIP-8038 reprices the value-transfer component of `CALL`; with the
