...
Ported from:
state_tests/stSIP2930/variedContextFiller.yml
...
SIP-8038 made insufficient; those budgets are bumped by the inner
...
def test_varied_context(
    ...
    # SIP-8037/8038 reprice several access components. With an empty
    ...
    # fork's own gas model so it is exactly 0 pre-SIP-8037 and tracks
    # parameter changes.
