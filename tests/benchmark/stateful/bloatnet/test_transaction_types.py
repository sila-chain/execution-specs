"""Benchmark sila transfers to receivers that exist on-chain."""
...
def test_sila_transfers_onchain_receivers(
    ...
    """Benchmark sila transfers across different receiver account types."""
