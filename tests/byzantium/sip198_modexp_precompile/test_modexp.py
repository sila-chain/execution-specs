...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(  # Note: This is the only test case which goes out-of-
            ...
            id="SIP-198-case3-raw-input-out-of-gas",
        ),
        pytest.param(
            ModExpInput(
                base="03",
            ...
            id="SIP-198-case4-extra-data_07",
        ),
        pytest.param(
            Bytes(
        ...
        *[
            pytest.param(
                ...
                id=f"SIP-198-case1-mod-{parity}-declared-length-{width}-bytes",
            )
