"""
Tests SIP-2929 precompile warming behavior.
...
@SIPChecklist.Precompile.Test.ForkTransition.Before.Cold(sip=[7951])
@SIPChecklist.Precompile.Test.ForkTransition.After.Warm(sip=[7951])
@pytest.mark.slow()
def test_precompile_warming(
    ...
    According to SIP-2929, when a transaction begins, accessed_addresses is
