"""Defines SIP-4788 specification constants and functions."""
...
class Spec:
    """
    Parameters from the SIP-4788 specifications as defined at
    https://sips.sila.org/SIPS/sip-4788#specification.
    """
...
@dataclass(frozen=True)
class SpecHelpers:
    """Helper functions closely related to the SIP-4788 specification."""
