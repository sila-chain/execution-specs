"""
Test CREATE2 collision interaction with SELFDESTRUCT (SIP-6780).
...
def test_selfdestruct_after_create2_collision(
    ...
    contract because SIP-6780 only allows destruction if the contract
    ...
    controller = pre.deploy_contract(
        ...
        + Op.SSTORE(
            ...
            Op.CALL(
                ...
                # refunded on collision under SIP-8037); size the budget
