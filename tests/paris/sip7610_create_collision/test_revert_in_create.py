"""
Test CREATE/CREATE2 collision scenarios with pre-existing storage per SIP-7610.
"""
...
REFERENCE_SPEC_GIT_PATH = "SIPS/sip-7610.md"
...
@pytest.mark.ported_from(
    [
        "https://github.com/sila/tests/tree/v13.3/src/GeneralStateTestsFiller/stCreate2/RevertInCreateInInitCreate2ParisFiller.json",  # noqa: E501
    ],
    pr=["https://github.com/sila/execution-specs/pull/2031"],
)
def test_collision_with_create2_revert_in_initcode(
    ...
    # Pre-existing account with storage - this causes collision per SIP-7610.
...
@pytest.mark.ported_from(
    [
        "https://github.com/sila/tests/tree/v13.3/src/GeneralStateTestsFiller/stCreate2/create2collisionStorageParisFiller.json",  # noqa: E501
    ],
    pr=["https://github.com/sila/execution-specs/pull/2031"],
)
...
def test_create2_collision_storage(
    ...
    fail per SIP-7610. The deployer stores the CREATE2 result to slot 0 (0 on
    failure).
    """
    deployer_code = (
