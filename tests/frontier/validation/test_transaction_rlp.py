...
def test_field_overflow(
    ...
    scalar as well; its 64-bit bound is a validation rule (SIP-2681),
...
def test_invalid_structure(
    ...
    before SIP-2718; afterwards the string is read as a typed
...
def test_invalid_signature_values(
    ...
    zero r or s, or a v that is neither 27, 28 nor an SIP-155 value.

    Before SIP-155 any v other than 27 or 28 is a plain invalid v;
