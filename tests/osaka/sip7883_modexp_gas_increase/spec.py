"""Defines SIP-7883 specification constants and functions."""
...
ref_spec_7883 = ReferenceSpec(
    "SIPS/sip-7883.md", "13aa65810336d4f243d4563a828d5afe36035d23"
)
...
class Spec:
    ...
    def calculate_gas_cost(cls, modexp_input: ModExpInput) -> int:
        """
        Calculate the ModExp gas cost according to SIP-2565 specification,
        overridden by the constants within `Spec7883` when calculating for the
        SIP-7883 specification.
        """
...
class Spec7883(Spec):
    """
    Constants and helpers for the ModExp gas cost increase SIP. These override
    the original Spec class variables for SIP-7883.
    """
