...
def test_transaction_gas_limit_cap(
    ...
    if tx_type >= 1:
        # Type 1: SIP-2930 Access List Transaction
    ...
    if tx_type == 3:
        # Type 3: SIP-4844 Blob Transaction
        ...
        # Type 4: SIP-7702 Set Code Transaction
...
def test_maximum_gas_refund(
    ...
    """Test the maximum gas refund behavior according to SIP-3529."""
...
def test_tx_gas_limit_cap_authorized_tx(
    ...
    def capped_intrinsic_cost(auth_count: int) -> int:
        ...
        if fork.is_sip_enabled(8037):
            # SIP-8037 caps only the regular dimension, not state gas.
    ...
    # SIP-7702 authorization transaction cost:
    ...
    tx = Transaction(
        ...
        # SIP-8037 reports a cap overflow as INTRINSIC_GAS_TOO_LOW.
        error=(
