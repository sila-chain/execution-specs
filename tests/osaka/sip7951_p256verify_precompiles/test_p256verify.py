...
@SIPChecklist.Precompile.Test.Inputs.Invalid()
@SIPChecklist.Precompile.Test.Inputs.Invalid.Crypto()
@SIPChecklist.Precompile.Test.Inputs.Invalid.Corrupted()
@SIPChecklist.Precompile.Test.InputLengths.Zero()
@SIPChecklist.Precompile.Test.InputLengths.Static.Correct()
@SIPChecklist.Precompile.Test.InputLengths.Static.TooShort()
...
@pytest.mark.parametrize("precompile_address", [Spec.P256VERIFY], ids=[""])
@SIPChecklist.Precompile.Test.GasUsage.Constant.Exact()
@SIPChecklist.Precompile.Test.GasUsage.Constant.Oog()
def test_gas(
    state_test: StateTestFiller, pre: Alloc, post: dict, tx: Transaction
) -> None:
...
@SIPChecklist.Precompile.Test.CallContexts.Static()
...
@pytest.mark.parametrize("precompile_address", [Spec.P256VERIFY], ids=[""])
@SIPChecklist.Precompile.Test.CallContexts.Initcode.Tx()
