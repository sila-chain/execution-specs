...
def test_valid(
    ...
    """Positive sila-mainnet test for the P256VERIFY precompile."""
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            H(  # 'hello world' k1 signed (with sil prefix) with private key 0xd946578401d1980aba1fc85df2a1ddc0d2d618aadd37b213f7f7f91a553b1499  # noqa: E501
...
def test_invalid(
    ...
    """
    Negative sila-mainnet test for the P256VERIFY precompile.
