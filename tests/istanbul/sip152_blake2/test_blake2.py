...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            id="SIP-152-case3-data4-gas-limit",
        ),
        pytest.param(
            Blake2bInput(),
            ExpectedOutput(
            ...
            id="SIP-152-case4-data5-gas-limit",
        ),
        pytest.param(
            Blake2bInput(
                f=False,
            ...
            id="SIP-152-case5-data6-gas-limit",
        ),
        pytest.param(
            Blake2bInput(
                rounds=1,
            ...
            id="SIP-152-case6-data7-gas-limit",
        ),
        pytest.param(
            Blake2bInput(
                rounds=0,
            ...
            id="SIP-152-case7-data8-gas-limit",
        ),
    ],
)
@pytest.mark.parametrize(
...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            id="SIP-152-modified-case8-data9-large-gas-limit",
        ),
        pytest.param(
            Blake2bInput(
                rounds=8000000,
            ...
            id="SIP-152-case8-data9-large-gas-limit",
