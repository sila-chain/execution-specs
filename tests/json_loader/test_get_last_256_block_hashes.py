...
from sila_types.bytes import Bytes8, Bytes32
...
from sila.forks.frontier.fork import BlockChain, get_last_256_block_hashes
from sila.forks.frontier.fork_types import Bloom
