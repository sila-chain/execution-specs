...
[`LeafNode`]: ref:sila.merkle_patricia_trie.LeafNode
[`ExtensionNode`]: ref:sila.merkle_patricia_trie.ExtensionNode
[`BranchNode`]: ref:sila.merkle_patricia_trie.BranchNode
...
class ExtensionNode:
    ...
    [ks]: ref:sila.merkle_patricia_trie.ExtensionNode.key_segment
    """
...
def encode_internal_node(node: Optional[InternalNode]) -> Extended:
    ...
    [`InternalNode`]: ref:sila.merkle_patricia_trie.InternalNode
    [`keccak256`]: ref:sila.crypto.hash.keccak256
    """
    unencoded: Extended
    if node is None:
...
class Trie(Generic[K, V]):
    ...
    [`keccak256`]: ref:sila.crypto.hash.keccak256
    [`default`]: ref:sila.merkle_patricia_trie.Trie.default
    """
    ...
    [`trie_set`]: ref:sila.merkle_patricia_trie.trie_set
    [`trie_get`]: ref:sila.merkle_patricia_trie.trie_get
    """
