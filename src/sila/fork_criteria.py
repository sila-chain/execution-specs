...
[`ByBlockNumber`]: ref:sila.fork_criteria.ByBlockNumber
[`ByTimestamp`]: ref:sila.fork_criteria.ByTimestamp
[`Unscheduled`]: ref:sila.fork_criteria.Unscheduled
"""
...
class ForkCriteria(ABC):
    ...
    [`__eq__`]: ref:sila.fork_criteria.ForkCriteria.__eq__
    [`__lt__`]: ref:sila.fork_criteria.ForkCriteria.__lt__
    [`check`]: ref:sila.fork_criteria.ForkCriteria.check
    """
    ...
    def __lt__(self, other: object) -> bool:
        ...
        [`BLOCK_NUMBER`]: ref:sila.fork_criteria.ForkCriteria.BLOCK_NUMBER
        [`TIMESTAMP`]: ref:sila.fork_criteria.ForkCriteria.TIMESTAMP
        [`UNSCHEDULED`]: ref:sila.fork_criteria.ForkCriteria.UNSCHEDULED
        """
        if isinstance(other, ForkCriteria):
            return self._internal < other._internal
        return NotImplemented
...
class ByBlockNumber(ForkCriteria):
    ...
    def check(self, block_number: Uint, timestamp: U256) -> bool:
        ...
        [`block_number`]: ref:sila.fork_criteria.ByBlockNumber.block_number
        """
...
class ByTimestamp(ForkCriteria):
    ...
    def check(self, block_number: Uint, timestamp: U256) -> bool:
        ...
        [`timestamp`]: ref:sila.fork_criteria.ByTimestamp.timestamp
        """
