...
implementation lives in [`sila.state_mpt`].

There is a distinction between an account that does not exist and
`EMPTY_ACCOUNT`.

[`sila.state_mpt`]: ref:sila.state_mpt
"""
