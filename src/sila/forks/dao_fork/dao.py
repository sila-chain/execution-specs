...
[`apply_dao`]: ref:sila.forks.dao_fork.dao.apply_dao
"""
...
[`v0.3.5-2016-07-01-48238c9`][solc]) and deployed on sila-mainnet in block
1,883,496:
...
def apply_dao(state: State) -> None:
    ...
    for address in DAO_ACCOUNTS:
        ...
        move_sila(tx_state, address, DAO_RECOVERY, balance)
    incorporate_tx_into_block(tx_state)
    apply_changes_to_state(state, extract_block_diff(block_state))
