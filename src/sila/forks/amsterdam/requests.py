"""
[SIP-7685] generalizes how the execution layer communicates validator actions
to the consensus layer. Rather than adding a dedicated header field for each
new action type (as [SIP-4895] did for withdrawals), the execution header
...
consolidation, and builder deposit/exit requests ([SIP-8282]) are produced by
...
[rh]: ref:sila.forks.amsterdam.blocks.Header.requests_hash
[dt]: ref:sila.forks.amsterdam.requests.DEPOSIT_REQUEST_TYPE
[wt]: ref:sila.forks.amsterdam.requests.WITHDRAWAL_REQUEST_TYPE
[ct]: ref:sila.forks.amsterdam.requests.CONSOLIDATION_REQUEST_TYPE
[bd]: ref:sila.forks.amsterdam.requests.BUILDER_DEPOSIT_REQUEST_TYPE
[be]: ref:sila.forks.amsterdam.requests.BUILDER_EXIT_REQUEST_TYPE
[pd]: ref:sila.forks.amsterdam.requests.parse_deposit_requests
[crh]: ref:sila.forks.amsterdam.requests.compute_requests_hash
[pgpr]: ref:sila.forks.amsterdam.fork.process_general_purpose_requests
"""
...
from sila.merkle_patricia_trie import trie_get
from sila.utils.hexadecimal import hex_to_bytes32
...
"""
SilaMainnet address of the beacon chain deposit contract. Scanning block
...
"""
Request type byte identifying a builder deposit request, per [SIP-8282].
...
"""
Request type byte identifying a builder exit request, per [SIP-8282].
...
def extract_deposit_data(data: Bytes) -> Bytes:
    ...
    [`InvalidBlock`]: ref:sila.exceptions.InvalidBlock
    """
...
def parse_deposit_requests(block_output: BlockOutput) -> Bytes:
    ...
    [addr]: ref:sila.forks.amsterdam.requests.DEPOSIT_CONTRACT_ADDRESS
    [sig]: ref:sila.forks.amsterdam.requests.DEPOSIT_EVENT_SIGNATURE_HASH
    [dt]: ref:sila.forks.amsterdam.requests.DEPOSIT_REQUEST_TYPE
    """
...
def compute_requests_hash(requests: List[Bytes]) -> Bytes:
    ...
    type-prefixed requests, as defined by [SIP-7685].
