...
class Withdrawal:
    ...
    [`block`]: ref:sila.forks.amsterdam.blocks.Block.withdrawals
    """
...
class Header:
    ...
    [`keccak256`]: ref:sila.crypto.hash.keccak256
    [RLP]: https://sila.github.io/sila-rlp/src/sila_rlp/rlp.py.html
    [`EMPTY_OMMER_HASH`]: ref:sila.forks.amsterdam.fork.EMPTY_OMMER_HASH
    """
    ...
    [logs bloom]: ref:sila.forks.amsterdam.bloom.logs_bloom
    """
    ...
    increases (e.g. the 60M limit proposed in SIP-7935).
    ...
    [SIP-7928]. See [`hash_block_access_list`][cbalh] for more
    details.

    [`keccak256`]: ref:sila.crypto.hash.keccak256
    [SIP-7928]: https://sips.sila.org/SIPS/sip-7928
    [cbalh]: ref:sila.forks.amsterdam.block_access_lists.hash_block_access_list
    """  # noqa: E501

    slot_number: U64
    """
    The slot number of this block as provided by the consensus layer.
    Introduced in [SIP-7843].
...
class Block:
    ...
    [withdrawals]: ref:sila.forks.amsterdam.blocks.Withdrawal
    """
    ...
    [headers]: ref:sila.forks.amsterdam.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:sila.forks.amsterdam.vm.instructions.log.log0
    [`LOG1`]: ref:sila.forks.amsterdam.vm.instructions.log.log1
    [`LOG2`]: ref:sila.forks.amsterdam.vm.instructions.log.log2
    [`LOG3`]: ref:sila.forks.amsterdam.vm.instructions.log.log3
    [`LOG4`]: ref:sila.forks.amsterdam.vm.instructions.log.log4
    """
