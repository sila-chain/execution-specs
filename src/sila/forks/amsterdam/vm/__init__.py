...
class BlockOutput:
    ...
    transactions_trie : `sila.fork_types.Root`
        Trie of all the transactions in the block.
    receipts_trie : `sila.fork_types.Root`
    ...
    block_logs : `Bloom`
        ...
        block.
    withdrawals_trie : `sila.fork_types.Root`
        Trie root of all the withdrawals in the block.
    blob_gas_used : `sila.base_types.U64`
...
def emit_transfer_log(
    ...
    """
    Emit a LOG3 for all SIL transfers satisfying SIP-7708.
