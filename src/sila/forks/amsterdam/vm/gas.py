...
class GasMeter:
    ...
    [`Evm`]: ref:sila.forks.amsterdam.vm.Evm
    """
    ...
    [commit]: ref:sila.forks.amsterdam.vm.gas.commit_state_gas
    """
    ...
    ([`repay_state_gas_spill`][repay]). [SIP-8037] names this
    quantity `state_gas_from_gas_left`.

    [repay]: ref:sila.forks.amsterdam.vm.gas.repay_state_gas_spill
    ...
    [Spill]: ref:sila.forks.amsterdam.vm.gas.GasMeter.state_gas_spilled
    [commit]: ref:sila.forks.amsterdam.vm.gas.commit_state_gas
    [restore]: ref:sila.forks.amsterdam.vm.gas.restore_state_gas
    [entry]: ref:sila.forks.amsterdam.vm.gas.restore_state_gas_to_entry
    """
...
class ExtendMemory:
    ...
    `expand_by`: `sila.base_types.Uint`
...
def commit_state_gas(gas_meter: GasMeter) -> None:
    ...
    [sd]: ref:sila.forks.amsterdam.vm.eoa_delegation.set_delegation
    [restore]: ref:sila.forks.amsterdam.vm.gas.restore_state_gas
    [entry]: ref:sila.forks.amsterdam.vm.gas.restore_state_gas_to_entry
...
def restore_state_gas(gas_meter: GasMeter) -> None:
    ...
    [baseline]: ref:sila.forks.amsterdam.vm.gas.GasMeter.state_gas_baseline
    [spill]: ref:sila.forks.amsterdam.vm.gas.GasMeter.state_gas_spilled
...
def restore_state_gas_to_entry(
    ...
    [commit]: ref:sila.forks.amsterdam.vm.gas.commit_state_gas
    [grant]: ref:sila.forks.amsterdam.vm.TransactionEnvironment.state_gas_reservoir
...
def calculate_message_call_gas(
    ...
    ----------
    value:
        The amount of `SIL` that needs to be transferred.
    gas :
...
def calculate_excess_blob_gas(
    ...
    Returns
    -------
    excess_blob_gas: `sila.base_types.U64`
...
def calculate_total_blob_gas(tx: Transaction) -> U64:
    ...
    Returns
    -------
    total_blob_gas: `sila.base_types.Uint`
...
def check_block_gas_capacity(
    ...
    [`TX_MAX_GAS_LIMIT`]: ref:sila.forks.amsterdam.vm.gas.GasCosts.TX_MAX_GAS_LIMIT
