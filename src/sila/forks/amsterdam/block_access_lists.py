"""
Block access lists (BALs), originally defined in [SIP-7928], record all
...
[bal]: ref:sila.forks.amsterdam.block_access_lists.BlockAccessList
"""
...
from sila.state import EMPTY_CODE_HASH, Account, Address, PreState
...
class StorageChange:
    ...
    [s]: ref:sila.forks.amsterdam.block_access_lists.SlotChanges
...
[`Block`]: ref:sila.forks.amsterdam.blocks.Block
[`Header`]: ref:sila.forks.amsterdam.blocks.Header
[`BALANCE`]: ref:sila.forks.amsterdam.vm.instructions.environment.balance
[ecs]: ref:sila.forks.amsterdam.vm.instructions.environment.extcodesize
[ecc]: ref:sila.forks.amsterdam.vm.instructions.environment.extcodecopy
[ech]: ref:sila.forks.amsterdam.vm.instructions.environment.extcodehash
[call]: ref:sila.forks.amsterdam.vm.instructions.system.call
[create]: ref:sila.forks.amsterdam.vm.instructions.system.create
"""
...
class BlockAccessListBuilder:
    ...
    [`BlockAccessList`]: ref:sila.forks.amsterdam.block_access_lists.BlockAccessList
    """  # noqa: E501
    ...
    [`incorporate_tx_into_block`]: ref:sila.forks.amsterdam.state_tracker.incorporate_tx_into_block
    """  # noqa: E501
...
def ensure_account(builder: BlockAccessListBuilder, address: Address) -> None:
    ...
    [ad]: ref:sila.forks.amsterdam.block_access_lists.AccountData
    """
...
def add_storage_read(
    ...
    list, not in the storage reads list, as per [SIP-7928].
    """
    ensure_account(builder, address)
...
def add_nonce_change(
    ...
    [`CREATE`]: ref:sila.forks.amsterdam.vm.instructions.system.create
    [`CREATE2`]: ref:sila.forks.amsterdam.vm.instructions.system.create2
    """
    ensure_account(builder, address)
...
def add_code_change(
    ...
    [`CREATE`]: ref:sila.forks.amsterdam.vm.instructions.system.create
    [`CREATE2`]: ref:sila.forks.amsterdam.vm.instructions.system.create2
    [sct]: ref:sila.forks.amsterdam.transactions.SetCodeTransaction
    """
    ensure_account(builder, address)
...
def add_touched_account(
    ...
    [`EXTCODEHASH`]: ref:sila.forks.amsterdam.vm.instructions.environment.extcodehash
    [`BALANCE`]: ref:sila.forks.amsterdam.vm.instructions.environment.balance
    [`EXTCODESIZE`]: ref:sila.forks.amsterdam.vm.instructions.environment.extcodesize
    [`EXTCODECOPY`]: ref:sila.forks.amsterdam.vm.instructions.environment.extcodecopy
    """  # noqa: E501
    ensure_account(builder, address)
    ...
    for address, slots in tx_state.storage_writes.items():
        for key, post_value in slots.items():
            ...
            if pre_value != post_value:
                ...
                # SIP-7928 uses U256 as it's more space-efficient in RLP.
