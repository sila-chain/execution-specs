...
from sila_types.frozen import modify
...
def get_pre_state_account_optional(
    ...
    [`EMPTY_ACCOUNT`]: ref:sila.state.EMPTY_ACCOUNT
    [pre]: ref:sila.forks.amsterdam.state_tracker.get_pre_state_account
...
def get_pre_state_account(
    ...
    [`EMPTY_ACCOUNT`]: ref:sila.state.EMPTY_ACCOUNT
    [opt]: ref:sila.forks.amsterdam.state_tracker.get_pre_state_account_optional
