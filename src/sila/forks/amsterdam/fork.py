...
from sila.state import EMPTY_CODE_HASH, Address, BlockDiff
...
def process_checked_system_transaction(
    ...
    # the same block — see SIP-7002 and SIP-7251 for this edge case.
...
def disburse_gas_fees(
    ...
    create_sila(tx_state, payer, U256(gas_refund_amount))
...
def process_withdrawals(
    ...
    for i, wd in enumerate(withdrawals):
        ...
        create_sila(wd_state, wd.address, U256(wd.amount) * GWEI_TO_WEI)
