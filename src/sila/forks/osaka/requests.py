...
[rh]: ref:sila.forks.osaka.blocks.Header.requests_hash
[dt]: ref:sila.forks.osaka.requests.DEPOSIT_REQUEST_TYPE
[wt]: ref:sila.forks.osaka.requests.WITHDRAWAL_REQUEST_TYPE
[ct]: ref:sila.forks.osaka.requests.CONSOLIDATION_REQUEST_TYPE
[pd]: ref:sila.forks.osaka.requests.parse_deposit_requests
[crh]: ref:sila.forks.osaka.requests.compute_requests_hash
[pgpr]: ref:sila.forks.osaka.fork.process_general_purpose_requests
"""
...
def parse_deposit_requests(block_output: BlockOutput) -> Bytes:
    ...
    [addr]: ref:sila.forks.osaka.requests.DEPOSIT_CONTRACT_ADDRESS
    [sig]: ref:sila.forks.osaka.requests.DEPOSIT_EVENT_SIGNATURE_HASH
    [dt]: ref:sila.forks.osaka.requests.DEPOSIT_REQUEST_TYPE
    """
