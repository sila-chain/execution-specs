...
class GasCosts:
    ...
    PRECOMPILE_ECADD: Final[Uint] = Uint(500)
    PRECOMPILE_ECMUL: Final[Uint] = Uint(40000)
    PRECOMPILE_ECPAIRING_BASE: Final[Uint] = Uint(100000)
    PRECOMPILE_ECPAIRING_PER_POINT: Final[Uint] = Uint(80000)
    ...
    OPCODE_EXTCODEHASH: Final[Uint] = Uint(400)
    ...
    OPCODE_BALANCE: Final[Uint] = Uint(400)
...
def calculate_memory_gas_cost(size_in_bytes: Uint) -> Uint:
    ...
    Returns
    -------
    total_gas_cost : `sila.base_types.Uint`
...
def max_message_call_gas(gas: Uint) -> Uint:
    ...
    Returns
    -------
    max_allowed_message_call_gas: `sila.base_types.Uint`
