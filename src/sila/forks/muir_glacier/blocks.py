...
class Header:
    ...
    [logs bloom]: ref:sila.forks.muir_glacier.bloom.logs_bloom
    """
    ...
    ref:sila.forks.muir_glacier.fork.calculate_block_difficulty
    """
    ...
    [u]: ref:sila.forks.muir_glacier.fork.validate_proof_of_work
    """
    ...
    [v]: ref:sila.forks.muir_glacier.fork.validate_proof_of_work
    """
...
class Block:
    ...
    [`header`]: ref:sila.forks.muir_glacier.blocks.Header
    """
    ...
    [headers]: ref:sila.forks.muir_glacier.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:sila.forks.muir_glacier.vm.instructions.log.log0
    [`LOG1`]: ref:sila.forks.muir_glacier.vm.instructions.log.log1
    [`LOG2`]: ref:sila.forks.muir_glacier.vm.instructions.log.log2
    [`LOG3`]: ref:sila.forks.muir_glacier.vm.instructions.log.log3
    [`LOG4`]: ref:sila.forks.muir_glacier.vm.instructions.log.log4
    """
