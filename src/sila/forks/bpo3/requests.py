...
[rh]: ref:sila.forks.bpo3.blocks.Header.requests_hash
[dt]: ref:sila.forks.bpo3.requests.DEPOSIT_REQUEST_TYPE
[wt]: ref:sila.forks.bpo3.requests.WITHDRAWAL_REQUEST_TYPE
[ct]: ref:sila.forks.bpo3.requests.CONSOLIDATION_REQUEST_TYPE
[pd]: ref:sila.forks.bpo3.requests.parse_deposit_requests
[crh]: ref:sila.forks.bpo3.requests.compute_requests_hash
[pgpr]: ref:sila.forks.bpo3.fork.process_general_purpose_requests
"""
...
def parse_deposit_requests(block_output: BlockOutput) -> Bytes:
    ...
    [addr]: ref:sila.forks.bpo3.requests.DEPOSIT_CONTRACT_ADDRESS
    [sig]: ref:sila.forks.bpo3.requests.DEPOSIT_EVENT_SIGNATURE_HASH
    [dt]: ref:sila.forks.bpo3.requests.DEPOSIT_REQUEST_TYPE
    """
