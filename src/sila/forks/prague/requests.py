...
[rh]: ref:sila.forks.prague.blocks.Header.requests_hash
[dt]: ref:sila.forks.prague.requests.DEPOSIT_REQUEST_TYPE
[wt]: ref:sila.forks.prague.requests.WITHDRAWAL_REQUEST_TYPE
[ct]: ref:sila.forks.prague.requests.CONSOLIDATION_REQUEST_TYPE
[pd]: ref:sila.forks.prague.requests.parse_deposit_requests
[crh]: ref:sila.forks.prague.requests.compute_requests_hash
[pgpr]: ref:sila.forks.prague.fork.process_general_purpose_requests
"""
...
def parse_deposit_requests(block_output: BlockOutput) -> Bytes:
    ...
    [addr]: ref:sila.forks.prague.requests.DEPOSIT_CONTRACT_ADDRESS
    [sig]: ref:sila.forks.prague.requests.DEPOSIT_EVENT_SIGNATURE_HASH
    [dt]: ref:sila.forks.prague.requests.DEPOSIT_REQUEST_TYPE
    """
