...
def block_hash(evm: Evm) -> None:
    ...
    Raises
    ------
    :py:class:`~sila.forks.prague.vm.exceptions.StackUnderflowError`
        If `len(stack)` is less than `1`.
    :py:class:`~sila.forks.prague.vm.exceptions.OutOfGasError`
...
def coinbase(evm: Evm) -> None:
    ...
    Raises
    ------
    :py:class:`~sila.forks.prague.vm.exceptions.StackOverflowError`
