...
class Withdrawal:
    ...
    [`block`]: ref:sila.forks.prague.blocks.Block.withdrawals
    """
...
class Header:
    ...
    [`keccak256`]: ref:sila.crypto.hash.keccak256
    [RLP]: https://sila.github.io/sila-rlp/src/sila_rlp/rlp.py.html
    [`EMPTY_OMMER_HASH`]: ref:sila.forks.prague.fork.EMPTY_OMMER_HASH
    """
    ...
    [logs bloom]: ref:sila.forks.prague.bloom.logs_bloom
    """
...
class Block:
    ...
    [`header`]: ref:sila.forks.prague.blocks.Header
    [withdrawals]: ref:sila.forks.prague.blocks.Withdrawal
    """
    ...
    [headers]: ref:sila.forks.prague.blocks.Header
    """
...
class Log:
    ...
    [`LOG0`]: ref:sila.forks.prague.vm.instructions.log.log0
    [`LOG1`]: ref:sila.forks.prague.vm.instructions.log.log1
    [`LOG2`]: ref:sila.forks.prague.vm.instructions.log.log2
    [`LOG3`]: ref:sila.forks.prague.vm.instructions.log.log3
    [`LOG4`]: ref:sila.forks.prague.vm.instructions.log.log4
    """
