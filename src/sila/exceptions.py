"""
Error types common across all Sila forks.
"""


class SilaException(Exception):  # noqa N818
    """
...
class InvalidBlock(SilaException):
    """
    Thrown when a block being processed is found to be invalid.
    """


class StateWithEmptyAccount(SilaException):
    """
    Thrown when the state has an empty account.
    """


class InvalidTransaction(SilaException):
    """
