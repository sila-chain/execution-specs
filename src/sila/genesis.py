...
[`parent_hash`]: ref:sila.forks.frontier.blocks.Header.parent_hash
[`GenesisConfiguration`]: ref:sila.genesis.GenesisConfiguration
[`add_genesis_block`]: ref:sila.genesis.add_genesis_block
"""
...
from sila.utils import has_field
...
class GenesisConfiguration:
    ...
    chain_id: U64
    """
    Discriminant between diverged blockchains; `1` for Sila's main network.
    """
    ...
    [`difficulty`]: ref:sila.forks.frontier.blocks.Header.difficulty
    """
    ...
    [`extra_data`]: ref:sila.forks.frontier.blocks.Header.extra_data
    """
    ...
    [`gas_limit`]: ref:sila.forks.frontier.blocks.Header.gas_limit
    """
    ...
    [`nonce`]: ref:sila.forks.frontier.blocks.Header.nonce
    """
    ...
    [`timestamp`]: ref:sila.forks.frontier.blocks.Header.timestamp
    """
...
def get_genesis_configuration(genesis_file: str) -> GenesisConfiguration:
    ...
    genesis_bytes = pkgutil.get_data("sila", genesis_path)
...
def add_genesis_block(
    ...
    governed by the general rules applying to all other Sila blocks.
    ...
    marked the "starting gun" for Sila block creation. Including its hash
    in the genesis block ensured a fair launch of the Sila mining process.
