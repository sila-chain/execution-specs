...
class ForkLoad:
    ...
    def has_slot_number(self) -> bool:
        """Check if the fork supports the SLOTNUM opcode (SIP-7843)."""
        try:
    ...
    def state_provider(self) -> Any:
        ...
        scheme (``sila.state_mpt``, ``sila.state_pbt``, ...).
        """
    ...
    @property
    def create_sila(self) -> Any:
        """create_sila function of the fork."""
        return self._module("state_tracker").create_sila
