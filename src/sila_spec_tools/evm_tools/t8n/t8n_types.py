...
from sila_rlp import Simple, rlp
...
from sila.merkle_patricia_trie import root, trie_get
from sila.state import EMPTY_CODE_HASH, apply_changes_to_state
from sila.utils.hexadecimal import hex_to_bytes, hex_to_u256, hex_to_uint
...
class Txs:
    ...
    def sign_transaction(self, json_tx: Any) -> None:
        ...
        Post spurious dragon, the transaction is signed according to SIP-155
